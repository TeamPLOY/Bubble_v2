...
import 'package:bubble_v2/components/signUp/TitleText.dart';
import 'package:bubble_v2/components/signUp/dropDown.dart';
...
class _SignUpPageState extends State<SignUpPage> {
  ...
  TextEditingController passwordController =
      TextEditingController(); //비밀번호 6자 이상
  TextEditingController repasswordController =
      TextEditingController(); //비밀번호 재확인
  TextEditingController nameController =
      TextEditingController(); //이름 2글자에서 5글자 내
  TextEditingController roomController =
      TextEditingController(); //호실 3글자가 들어와야함
                                    ...
                                    child: Column(
                                      children: [
                                        GestureDetector(
                                            ...
                                            child: Text(
                                              '재전송',
                                              style: AppTextStyles.M12.copyWith(
                                                  color: AppColor.red),
                                            )),
                                        Container(
                                          width: 33,
