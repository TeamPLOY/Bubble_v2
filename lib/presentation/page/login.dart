...
import 'package:bubble_v2/presentation/widget/form/InputForm.dart';
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    GestureDetector(
                      onTap: (){},
                      child: Text('이메일/비밀번호 찾기',style: AppTextStyles.M14.copyWith(color: AppColor.gray400),)
                    )
                  ],
                ),
                const SizedBox(height: 20,),
                ...
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: (){},
                      child: Text('회원가입',style: AppTextStyles.S14.copyWith(color: AppColor.blue400),),
                    )
                  ],
                )
              ],
